        ...
        <div class="u-row v-row-columns-background-color-background-color" style="Margin: 0 auto;min-width: 320px;max-width: 640px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #022459; height:70px; border-radius:50px">
            <div class="v-row-background-image--inner" style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                ...
                <div class="v-color v-text-align v-line-height" style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                    <h3 style="text-align: center;"><span style="color: #ffffff;">Sayın {{ Str::ucfirst($details['name']) }} mesajınız  iletilmiştir. Yetkili personelimiz size kısa sürede dönüş sağlayacaktır. </span></h3>
                </div>
        ...
        <table id="u_content_text_5" class="u_content_text" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            <tbody>
                ...
                <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px;font-family:arial,helvetica,sans-serif;" align="left">
                    ...
                    <div class="v-color v-text-align v-line-height" style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                        <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="color: #444444; font-size: 14px; line-height: 19.6px;"><strong><span style="font-size: 18px; line-height: 25.2px;">Mesaj Başlığınız : </span></strong><br> <strong><span style="font-size: 18px; line-height: 25.2px;">{{ $details['title'] }}</span></strong></span></p>
                    </div>
            ...
            <tbody>
                <tr>
                    <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px;font-family:arial,helvetica,sans-serif;" align="left">
                        ...
                        <div class="v-color v-text-align v-line-height" style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                        <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="color: #444444; font-size: 14px; line-height: 19.6px;"><strong><span style="font-size: 18px; line-height: 25.2px;">Mesaj İçeriğiniz : </span></strong> <br> <strong><span style="font-size: 18px; line-height: 25.2px;"> {{ $details['content'] }}</span></strong>  </span></p>
                        </div>
            ...
            <tbody>
                <tr>
                    <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px;font-family:arial,helvetica,sans-serif;" align="left">
                        ...
                        <div class="v-color v-text-align v-line-height" style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                        <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="color: #444444; font-size: 14px; line-height: 19.6px;"><strong><span style="font-size: 18px; line-height: 25.2px;">Mesaj Türü : </span></strong> <br> <strong><span style="font-size: 18px; line-height: 25.2px;"> {{ $details['type'] }}</span></strong>  </span></p>
                        </div>
