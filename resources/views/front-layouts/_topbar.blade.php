        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    @elseif (session('createCustomer'))
                    <div class="alert alert-success alert-dismissable fade show" role="alert">
                    <strong>{{ session('createCustomer') }}</strong>
                        <button type="button" class="close" data-dismiss="alert" aria-label="close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="our-link">
                        <ul>
                            <li style="width:22px"><a target="_blank" style="color:#fff;
                                background:
                                radial-gradient(#25d366 56%,transparent 0);" href="https://api.whatsapp.com/send?phone=+905317238357"><i style="width: 22px; text-align: center;" class="fab fa-whatsapp"></i></a></li>
                            @if (Session::get('customer'))
                            <li><a href="{{ route('front.profile') }}">{{ Str::ucfirst(Session::get('customer')['name']) }}</a></li>
